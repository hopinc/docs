...
- You can send events directly to [Tokens](/channels/tokens), instead of sending
  them to channels
- You can keep realtime, persisted "state" within a channel, which all clients
  ...
  [Read more ➜](/channels/channel-state)
...
[generate Tokens](/channels/tokens) and
[create Channels](/channels/creating-channels). You can then use the
[client-side SDKs](/sdks/client/js) to subscribe to channels.

## Jump To

- [Learn about Channel State](/channels/channel-state)
- [Learn about Channel Tokens (authenticate users to Channels)](/channels/tokens)
- [Using Channels with React](/channels/reference/react)
- [Creating Channels with the Hop SDK](/channels/reference/creating-channels)
- [Updating Channel State using the Hop SDK](/channels/reference/updating-channel-state)
- [Sending Messages to Channels using the Hop SDK](/channels/reference/sending-messages)
...
the Hop SDK or via a custom [Leap](/channels/internals/leap) implementation. The
...
[Leap](/channels/internals/leap) documentation.
...
[Channel State](/channels/channel-state)
...
[How to send Messages to Channels](/channels/reference/sending-messages)
