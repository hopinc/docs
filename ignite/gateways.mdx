...
It's easiest to create a gateway through our console, however keep in mind that
all of Hop is built around a REST API, so you can automate this if you need to.

Navigate to the Gateways tab in an Ignite deployment:

![](/images/hop-gw-demo-1.webp)

Click on the "Create Gateway" button in the top right:

![](/images/hop-gw-demo-2.webp)

You will be presented with a modal:

![](/images/hop-gw-demo-3.webp)
...
![](/images/hop-gw-demo-4.webp)

Here, you can manage the `.hop.sh` domain as well as add your own custom ones.
To add a custom domain, click on the Attach Domain button in the top right of
the page.

You will be presented with this modal, where you should enter your desired
domain.

![](/images/hop-gw-demo-5.webp)
...
Details about this record will be shown on screen in a modal after entering the
domain.
