...
Pipe supports multiple ingest protocols for _sending_ streams to Pipe: RTMP and RTP (MPEG-TS). You can set the ingest protocol to use when creating a Pipe room.
