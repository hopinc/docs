...
If using Next.js, then you need to make sure that the client gets initialized on the **client-side**, not the server. To do this, we recommend initializing the Hop Client in a `useEffect` in your `_app` file, for example:
