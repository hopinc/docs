...
<div className="pb-[56.25%] relative h-[0]">
	<iframe className="w-full h-full top-0 left-0 absolute" src="https://www.youtube.com/embed/VcHF3hm64Zc?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
</div>
