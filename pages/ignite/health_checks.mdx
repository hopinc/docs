---
title: Health Checks
description: Health Checks allow you to make sure traffic is only directed to running containers
---

import Image from 'next/future/image';
import hc from '../../assets/images/health-check.png';
...
3. Click **Create Check** in the top right
   ...
   <center>
   	<Image width={500} height={500} src={hc} />
   </center>
