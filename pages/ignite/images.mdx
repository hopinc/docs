---
title: Images
description: Guide to managing Docker images on Hop
---

import Image from 'next/future/image';
import hopPat2 from '../../assets/images/hop-pat-2.png';
import hopImages1 from '../../assets/images/hop-images-1.png';
import {Bleed} from '../../components/bleed';

# Images

When creating a deployment, you can specify an image from a remote registry (such as Dockerhub or GCR), or you can use the Hop Image Registry. When using the `hop deploy` command or GitHub integration, you're using our registry by default.
...
To log in to the registry, you'll have to use a Hop PAT. They can be created from [this page](https://console.hop.io/settings/pats) on the console (User Settings -> Personal Tokens).
...
> You can use the <span><img className="no-styles" style={{display: "inline", height: "1em", margin: "0px 3px"}} src="/icons/clipboard.png"/></span> button to copy the token to your clipboard
...
> If you don't know your project's namespace, you can find it [on this page](https://console.hop.io/project/settings)
...
### View the Image
Once your image is pushed, you can view it on the [Images tab](https://console.hop.io/ignite/images) of Ignite:

<Bleed>
    <Image src={hopImages1}/>
</Bleed>
