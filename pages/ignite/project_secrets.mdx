...
### In Hop Deployments
When creating a deployment or individual container, you can set environment variables that reference project secrets. Their values will automatically be updated when you update the secrets.
