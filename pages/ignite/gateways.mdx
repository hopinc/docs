...
Currently, both gateway types [round-robin](https://en.wikipedia.org/wiki/Round-robin_DNS) requests between containers. In the future, there will be more fine grained controls for load balancing requests.
