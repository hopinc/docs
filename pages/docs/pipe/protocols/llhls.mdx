...
On frontend clients, Leap sends periodic telemetry data about the users' current playback environment, inclduing currently synced HLS playlist. If we detect that more than 5% of your room is behind the current playlist, we do 2 things:
