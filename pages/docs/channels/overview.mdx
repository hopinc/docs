...
- You can give Channels the `stateful` capability, which allows you to keep state within a channel and automatically sync clients with that state when they connect
...
Tokens can subscribe to many channels at once. They are permenant until deleted.
